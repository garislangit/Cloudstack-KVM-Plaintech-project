...
<title>Plaintech Reseller Order Portal</title>
...
<img src="images/plaintechorder.jpg" width="640" height="150">
	...
	<!-- Register step 1 -->
	  <form  method="post" action="resellerstep2.php" name="regstep1">
			<fieldset>
				...
				<div>
                 ...
                 <div>
                    ...
                    <input name="postalcode" type="text" required="required">
                </div>
				      <div>
                    <label for="ccc">Chamber of Commerce Code*</label>
                    <input name="ccc" type="text" required="required">
                </div>
				    <div>
                    ...
                    <input name="cmail" type="text">
                </div>
                </div>
				    <div>
                    <label for="fax">Fax*</label>
                    <input name="fax" type="text" required="required">
                </div>
                <div>
...
<fieldset>
	<legend>Optional Functionalities</legend>
             	...
             	<div>
            		...
            		<select name="sla" id="sla">
						<option value="none"></option>
                   		 <option value="24hour">24/7 support</option>
						 <option value="uptime">Guaranteed Uptime</option>
            		</select>
				</div>
	</fieldset>
