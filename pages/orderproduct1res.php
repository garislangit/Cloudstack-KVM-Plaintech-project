...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body style="padding-top: 60px;">
    ...
    <div class="container">
      ...
      <h1>Register new reseller account step 1/3</h1>
      <p>Please fill the following form. Fields with an "*" symbol are required.</p><br />

	  <form  method="post" action="checkorder1.php" name="orderproduct1">
			<fieldset>
