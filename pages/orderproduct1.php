...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body style="padding-top: 60px;">
    ...
    <div class="container">
      ...
      <h1>Register new user account step 1/3</h1>
      <p>Please fill the following form. Fields with an <strong>*</strong> symbol are required="required".</p><br />
		<div class="row">
  		<div class="span6">

	  <form  method="post" action="orderproduct2.php" name="userstep1">
			<fieldset>
                ...
                <div class="span6"> <!-- This div starts the second colom -->
                <div>
                ...
                </div> <!-- This div closes the second colom -->
                </div> <!-- Close both coloms -->
				</fieldset>
